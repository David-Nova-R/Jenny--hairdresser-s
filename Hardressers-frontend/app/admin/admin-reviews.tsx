    ...
    <section className="rounded-3xl border border-[#D4AF37]/20 bg-gradient-to-b from-[#0a0a0a] to-black p-4 sm:p-5">
      <div className="mb-6 flex flex-col gap-3 sm:mb-8 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-400">
            {tr('reviews_admin_subtitle', lang)}
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {reviews.map(review => {
            const rating = review.stars / 2; // convert 10 → 5
                ...
                <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                  <div className="flex-1">
                    <div className="mb-2 flex flex-wrap items-center gap-3">
                      ...
                      >
                        {review.isVisible
                          ? tr('reviews_visible', lang)
                          : tr('reviews_hidden', lang)}
                      </span>
                    </div>
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:gap-3 lg:flex-col lg:gap-2">
                    <button
                      type="button"
                      onClick={() =>
                        void handleToggleVisibility(review.id)
                      }
                    ...
                    >
                      ...
                      {review.isVisible
                        ? tr('reviews_hide', lang)
                        : tr('reviews_show', lang)}
                    </button>
